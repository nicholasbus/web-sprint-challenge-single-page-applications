...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    * The `useRouteMatch` hook is used to match or get the current URL and use it in some way.

1. How would you explain form validation to someone who has never programmed before?
    * Form validation is a process in which we are making sure that the user is submitting valid data that we can use. 

1. In 1-2 sentences, define end to end testing.
    * End to end testing checks if the user can complete some action that the application is built for. End to end testing focuses on the UI to mimic how a user might interact with the app.
